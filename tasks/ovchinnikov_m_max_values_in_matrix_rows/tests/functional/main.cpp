...
const std::array<TestType, 5> kTestParam = {
    ...
    std::make_tuple(InType{{1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           ...
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9},
                           {7, 6, 3, 2, 9, 4, 2, 5, 8}, {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8},
                           {1, 2, 3, 4, 5, 6, 7, 8, 9}, {7, 6, 3, 2, 9, 4, 2, 5, 8}},
                    "Large_matrix")};
